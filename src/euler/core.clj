...
(defn -main [& args]
 	...
 	(time(println (format "Problem No %d = %s" 12 (euler.problem12/calc 500))))
 	(time(println (format "Problem No %d = %s" 13 (euler.problem13/calc 10))))
  ; (time(println (format "Problem No %d = %s" 14 (euler.problem14/calc 1000000))))
 	...
 	(time(println (format "Problem No %d = %s" 20 (euler.problem20/calc 100))))
 	(time(println (format "Problem No %d = %s" 21 (euler.problem21/calc 10000))))
